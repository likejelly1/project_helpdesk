...
<head>
  ...
  <title>Login &mdash; Helpdesk</title>
        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            <div class="login-brand">
              <img src="<?= site_url("public/stisla/img/MHA.png") ?>" alt="logo" width="100">
            </div>

            <?php $this->session = \Config\Services::session(); 
                  if($this->session->getFlashdata('fail_login')) { ?>
            <div class="alert alert-danger alert-has-icon">
              <div class="alert-icon"><i class="far fa-lightbulb"></i></div>
              <div class="alert-body">
                <div class="alert-title">Login Failed !</div>
                NIK or Password is wrong.
              </div>
            </div>
            <?php } ?>
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                <form method="POST" action="<?= base_url('home'); ?>" class="needs-validation" novalidate="">
