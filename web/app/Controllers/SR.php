...
class SR extends BaseController
{
	...
	public function dashboard() {
		...
		//$src = "https://app.powerbi.com/view?r=eyJrIjoiOTcxNWUxNTktYjFkNC00ZGIwLTk4YjAtZjU2YzlkMWIyY2I1IiwidCI6ImE1ODc4MTNhLTVhODUtNGFjOS05MmFlLTc5NGU4Y2E2YmMxZSIsImMiOjEwfQ%3D%3D";
		$src = "https://app.powerbi.com/view?r=eyJrIjoiZWEyZDQxMDEtZGQzZS00MjBkLTg5YjAtYTUxY2YxNzg1YzhiIiwidCI6ImE1ODc4MTNhLTVhODUtNGFjOS05MmFlLTc5NGU4Y2E2YmMxZSIsImMiOjEwfQ%3D%3D";
		
		echo view('header');
		echo '<iframe style="width: 100%" height="1060" src="https://app.powerbi.com/view?r=eyJrIjoiZWEyZDQxMDEtZGQzZS00MjBkLTg5YjAtYTUxY2YxNzg1YzhiIiwidCI6ImE1ODc4MTNhLTVhODUtNGFjOS05MmFlLTc5NGU4Y2E2YmMxZSIsImMiOjEwfQ%3D%3D" frameborder="0" allowFullScreen="true"></iframe>';
	 	echo view('footer');
	}
	...
	public function ajaxSRAll()
	{
		if ($this->request->isAJAX())
        {
	        ...
	        foreach ($data_model as $key => $value) 
	        {
	        	...
	        	if($value['status'] == 0) {
		        	if($value['pic'] == $nik || isMaster_editSR())
